...
\subsection{Summary file options}
...
lines of the FASTQ file. If there is something other than the sample ID
in the header, you need to specify the first non-sample ID character
in \texttt{BARCODES\_SEPARATOR}. (i.e. often, sequences in these kinds of
files are labeled like:
...
\subsection{PiCRUST}
\textbf{DEPRECATED: the pipeline no longer does this automatically.}
